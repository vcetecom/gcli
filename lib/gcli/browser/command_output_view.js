...
var commandOutputViewCss = require('text!gcli/browser/command_output_view.css');
var commandOutputViewHtml = require('text!gcli/browser/command_output_view.html');
...
function imageUrl(path) {
  try {
    return require('text!gcli/browser/' + path);
  }
  catch (ex) {
