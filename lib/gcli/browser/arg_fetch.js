...
var getField = require('gcli/browser/field').getField;
var Templater = require('gcli/browser/domtemplate').Templater;

var editorCss = require('text!gcli/browser/arg_fetch.css');
var argFetchHtml = require('text!gcli/browser/arg_fetch.html');
